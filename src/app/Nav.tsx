   ...
   <div>
     <nav className='flex max-sm:justify-between justify-evenly items-center relative z-40 bg-amber-400 border-b-[3px] p-3 border-black mb-8'>
       ...
       <div className="w-4/12">
          <input placeholder="search ..." className='w-full h-10 bg-amber-100 border-2 border-black placeholder-black px-4 focus:ring-4 ring-orange-100 focus:bg-orange-50'></input>
       </div>
       <div className='h-10 p-1 cursor-pointer hover' onClick={()=>setIsMenuShown(!isMenuShown)}>
           <Image style={{height:"100%", width:"auto"}} src={menuIcon} alt="menu icon"></Image>
       </div>
     </nav>
     
    <div data-is-menu-shown={isMenuShown} className="absolute right-0 top-0 w-full h-screen bg-amber-400 z-20 pt-4 max-w-md text-lg data-[is-menu-shown=false]:hidden">
      <ul className="flex flex-col gap-y-6 pt-20 font-bold ">
        <li  data-are-categories-shown={areCategoriesShown} className="px-8 flex flex-wrap group cursor-pointer hover:underline"><span>categories</span> 
            ...
            <ul className="font-semibold text-base w-full mt-1 group-data-[are-categories-shown=false]:hidden">
              <li className="cursor-pointer hover:underline px-4 mb-1">category 1</li>             
              <li className="cursor-pointer hover:underline px-4 mb-1">category 1</li>
              <li className="cursor-pointer hover:underline px-4 mb-1">category 1</li>
              <li className="cursor-pointer hover:underline px-4 mb-1">category 1</li>
        ...
        <li className="px-8 font-normal border-t-2 border-dashed border-black pt-2 cursor-pointer hover:underline">log out</li>
      </ul>
    </div>
  </div> )
}