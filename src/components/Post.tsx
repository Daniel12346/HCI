          ...
          <div className="w-11/12 max-w-lg border-2 border-black bg-stone-100">
            <div className="p-3">
               <div  className="relative mb-3 h-[25vh] max-h-44 border-2 border-black">
                    ...
                    <span className="inline-block bottom-[-0.6rem] left-3 absolute bg-yellow-100 w-5/6 font-bold p-1 border-2 border-black">naslov posta adipiscing enim eu turpis egestas </span>
               </div>
               ...
               <div className="flex justify-between border-t-2 border-dashed border-black pt-2">
